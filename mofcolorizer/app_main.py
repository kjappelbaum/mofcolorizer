                        ...
                        [
                            ...
                            html.P(
                                [
                                    ...
                                    html.A(
                                        "Kevin", href="mailto:kevin.jablonka@epfl.ch"
                                    ),
                                    ".",
                                ]
                            ),
                            ...
                            html.P(
                                "We will store no personal data that can identify you."
                            ),
                        ],
                    ),
                    html.Hr(),
...
def main_callback(content, new_filename):
    filename = session["filename"]

    # check if new file was uploaded
    if new_filename and new_filename != filename:
        string = content.split(";base64,")[-1]
        cif = drc.b64_to_pil(string)
