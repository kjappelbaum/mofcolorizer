...
SCALER = joblib.load(os.path.join(THIS_DIR, 'scaler_run_2020_07_21_08_50_1595314233.joblib'))
MODEL_MEDIAN = joblib.load(os.path.join(THIS_DIR, 'regressor_medianrun_2020_07_21_08_50_1595314233.joblib'))
MODEL_01 = joblib.load(os.path.join(THIS_DIR, 'regressor_0_1run_2020_07_21_08_50_1595314233.joblib'))
MODEL_09 = joblib.load(os.path.join(THIS_DIR, 'regressor_0_9run_2020_07_21_08_50_1595314233.joblib'))
